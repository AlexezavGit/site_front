...
import {
  ArrowRight, Users, Banknote, Heart,
  TrendingUp, CheckCircle2, AlertCircle, Shield, ExternalLink
} from "lucide-react";
import { FeelAgainLogo } from "@/components/layout/FeelAgainLogo";
...
const gaps = [
  ...
  { num: "04", title: "Тіньової економіки", desc: "~8,000 приватних фахівців без сертифікації, без видимості для держави, без інституційного фінансування." },
...
export default function Home() {
  return (
    <div>
      ...
      <section
        style={{
          background: `linear-gradient(145deg, #091d30 0%, ${NAVY} 45%, #162944 100%)`,
          position: "relative",
          overflow: "hidden",
        }}
      ...
      >
        ...
        <div
          style={{
            ...
            background: "radial-gradient(ellipse 70% 60% at 50% -10%, rgba(212,160,23,0.08) 0%, transparent 70%)",
            pointerEvents: "none",
          }}
        />
        ...
        >
          <div className="flex flex-col items-center text-center">
            ...
            <motion.div
              ...
              className="mb-10"
            >
              <FeelAgainLogo variant="dark" size="lg" />
            </motion.div>
            ...
            {/* Heading */}
            <h1
              className="text-4xl md:text-6xl mb-6 max-w-4xl leading-tight"
              style={{ color: "white", fontWeight: 300, letterSpacing: "-0.01em" }}
            >
              Цифрова інфраструктура для<br />
              <span style={{ color: GOLD }}>психічного здоров'я України</span>
            </h1>

            {/* Sub */}
            <p
              className="text-base md:text-lg max-w-2xl mb-4 leading-relaxed"
              style={{ color: "rgba(255,255,255,0.70)" }}
            >
              FEEL Again з'єднує три роз'єднані сектори надавачів з бенефіціарами через єдиний
              довірений цифровий шар. Не маркетплейс — фінансові рейки для сектору MHPSS.
            </p>
            <p
              className="text-sm max-w-xl mb-10 italic"
            ...
            <div className="flex flex-wrap gap-3 justify-center">
              <Link href="/beneficiaries">
                <button
                  style={{
                    background: GOLD, color: NAVY, fontWeight: 600,
                ...
                >
                  Отримати підтримку <ArrowRight style={{ width: 16, height: 16 }} />
                </button>
              </Link>
              <Link href="/pro">
                <button
                  style={{
                    ...
                    cursor: "pointer", fontSize: "0.9375rem", letterSpacing: "0.02em",
                  }}
      ...
      {/* ═══════════════════════════════════════════════════════
          STATS STRIP — dark navy, gold numbers
      ══════════════════════════════════════════════════════════ */}
      <section style={{ background: "#0B1E30", borderTop: `1px solid rgba(212,160,23,0.15)`, borderBottom: `1px solid rgba(212,160,23,0.15)` }} className="py-10">
        <div className="container">
          <div className="flex items-center gap-2 mb-6">
            ...
            <span style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.7rem", letterSpacing: "0.12em", textTransform: "uppercase" }}>
              Канонічний датасет · Doc 4 · Єдине джерело правди
            </span>
          </div>
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {canonicalStats.map((stat, i) => (
              ...
              >
                <div style={{ color: GOLD, fontSize: "1.75rem", fontWeight: 700, lineHeight: 1.1, marginBottom: "0.35rem" }}>
                  {stat.value}
                </div>
                <div style={{ color: "rgba(255,255,255,0.85)", fontSize: "0.75rem", fontWeight: 600, marginBottom: "0.25rem", lineHeight: 1.3 }}>
                  {stat.label}
                </div>
      ...
      {/* ═══════════════════════════════════════════════════════
          AUDIENCE CARDS — 4 value props
      ══════════════════════════════════════════════════════════ */}
      <section className="py-16">
        <div className="container">
          <div className="text-center mb-12">
            <h2 className="text-3xl font-bold mb-3" style={{ color: NAVY }}>Ціннісна пропозиція</h2>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-5">
            {audienceCards.map((card, i) => (
              ...
              >
                <div
                  className="h-full rounded-xl p-5 flex flex-col transition-all duration-200"
                  style={{
                    background: card.bg,
                    border: `1px solid ${card.accent}33`,
                  }}
                  onMouseEnter={e => ((e.currentTarget as HTMLElement).style.border = `1px solid ${card.accent}66`)}
                  onMouseLeave={e => ((e.currentTarget as HTMLElement).style.border = `1px solid ${card.accent}33`)}
                >
                  <card.icon className="mb-3" style={{ color: card.accent, width: 36, height: 36 }} />
                  <h3 className="font-bold text-base mb-1" style={{ color: NAVY }}>{card.audience}</h3>
                  <p className="text-sm text-muted-foreground mb-4 italic">{card.tagline}</p>
                  <ul className="space-y-2 mb-5 flex-1">
                    {card.points.map((point, j) => (
                      <li key={j} className="flex items-start gap-2 text-sm">
                        <CheckCircle2 style={{ color: card.accent, width: 15, height: 15, marginTop: 2, flexShrink: 0 }} />
                  ...
                  <Link href={card.href}>
                    <button
                      style={{
                        ...
                        border: `1px solid ${card.accent}66`, color: card.accent,
                        background: "transparent", cursor: "pointer", fontSize: "0.8125rem",
                        fontWeight: 500, display: "flex", alignItems: "center", justifyContent: "center", gap: "0.3rem",
                      }}
                      onMouseEnter={e => ((e.currentTarget as HTMLElement).style.background = `${card.accent}14`)}
                      onMouseLeave={e => ((e.currentTarget as HTMLElement).style.background = "transparent")}
                    >
                      {card.cta} <ArrowRight style={{ width: 13, height: 13 }} />
                    </button>
                  </Link>
                </div>
              </motion.div>
      ...
      {/* ═══════════════════════════════════════════════════════
          PROBLEM — dark navy equation
      ══════════════════════════════════════════════════════════ */}
      <section style={{ background: "#091d30" }} className="py-16">
        <div className="container">
          <div className="max-w-3xl mx-auto text-center">
            <h2 className="text-3xl mb-4" style={{ color: "white", fontWeight: 300 }}>
              Чому існує FEEL Again
            </h2>
            <div
              className="rounded-2xl p-7 mb-6"
              style={{ background: "rgba(255,255,255,0.04)", border: "1px solid rgba(212,160,23,0.18)" }}
            >
              <p style={{ color: "rgba(255,255,255,0.45)", fontSize: "0.75rem", letterSpacing: "0.08em", textTransform: "uppercase", marginBottom: "0.75rem" }}>
                Структурне пляшкове горлечко
              </p>
              <p className="text-lg" style={{ color: "white", fontWeight: 300 }}>
                1 терапевт × 25 пацієнтів/тиждень × 50 тижнів ={" "}
                <span style={{ color: GOLD, fontWeight: 700 }}>1,250 / рік</span>
              </p>
              <p className="mt-2 text-lg" style={{ color: "white", fontWeight: 300 }}>
                ~4,000 фахівців × 25/тиждень ≈{" "}
                <span style={{ color: GOLD, fontWeight: 700 }}>100,000 людей / рік</span>
              </p>
              <p className="mt-3 text-2xl font-bold" style={{ color: "#EF4444" }}>
                = 1% від 9.6M, які потребують допомоги
              </p>
            </div>
            <p style={{ color: "rgba(255,255,255,0.65)" }}>
              Навчання не може закрити цю прогалину. Єдине рішення — змінити{" "}
              <strong style={{ color: "white" }}>співвідношення</strong>.
        ...
        <div className="container">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-5">
            {gaps.map((gap, i) => (
              ...
              >
                <div
                  className="h-full rounded-xl p-5 transition-shadow hover:shadow-md"
                  style={{ background: "white", border: `1px solid #E5E7EB` }}
                  onMouseEnter={e => ((e.currentTarget as HTMLElement).style.borderColor = `${GOLD}44`)}
                  onMouseLeave={e => ((e.currentTarget as HTMLElement).style.borderColor = "#E5E7EB")}
                >
                  <div className="flex items-start gap-3">
                    <span style={{ color: GOLD, fontSize: "2rem", fontWeight: 800, lineHeight: 1, opacity: 0.6 }}>
                      {gap.num}
                    </span>
                    <div>
      ...
      {/* ═══════════════════════════════════════════════════════
          PROGRAM SUMMARY — dark navy, gold numbers
      ══════════════════════════════════════════════════════════ */}
        ...
        <div className="container">
          <div className="grid md:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div key={i}>
                <div style={{ color: GOLD, fontSize: "1.875rem", fontWeight: 700, marginBottom: "0.25rem" }}>
                  {item.val}
                </div>
      ...
      {/* ═══════════════════════════════════════════════════════
          CTA CARDS — 3 audience entry points
      ══════════════════════════════════════════════════════════ */}
      <section className="py-16">
        <div className="container">
          <div className="grid md:grid-cols-3 gap-6">
            ...
            {/* Beneficiaries */}
            <div className="rounded-xl p-6" style={{ background: "rgba(37,99,235,0.06)", border: "1px solid rgba(37,99,235,0.2)" }}>
              <AlertCircle style={{ color: "#2563EB", width: 32, height: 32, marginBottom: 12 }} />
              <h3 className="font-bold text-lg mb-2" style={{ color: NAVY }}>Потрібна допомога?</h3>
            ...
            {/* Professionals */}
            <div className="rounded-xl p-6" style={{ background: "rgba(22,163,74,0.06)", border: "1px solid rgba(22,163,74,0.2)" }}>
              <Users style={{ color: "#16A34A", width: 32, height: 32, marginBottom: 12 }} />
              <h3 className="font-bold text-lg mb-2" style={{ color: NAVY }}>Ви фахівець?</h3>
              <p className="text-sm text-muted-foreground mb-4">
              ...
              <Link href="/pro">
                <button style={{
                  width: "100%", padding: "0.5rem 1rem", borderRadius: "0.375rem",
                  border: "1px solid rgba(22,163,74,0.5)", color: "#16A34A",
            ...
            {/* Donors */}
            <div className="rounded-xl p-6" style={{ background: "rgba(212,160,23,0.06)", border: "1px solid rgba(212,160,23,0.25)" }}>
              <Shield style={{ color: GOLD, width: 32, height: 32, marginBottom: 12 }} />
              <h3 className="font-bold text-lg mb-2" style={{ color: NAVY }}>Хочете підтримати?</h3>
              <p className="text-sm text-muted-foreground mb-4">
          ...
          <div className="mt-10 text-center">
            <a
              ...
              style={{
                ...
                color: "rgba(0,0,0,0.45)", fontSize: "0.8125rem", textDecoration: "none",
              }}
